...
<body>
    <div class="mobile-top-bar visible-sm-down flex">
        ...
        <div class="mobile-logo">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                ...
                <g>
                    <path class="st1"
                        d="M3.28,32.51v-15.3h9.2l1.08,1.34v12.62l-1.07,1.34H3.28z M10.87,19.83h-4.7v10.06h4.7V19.83z" />
                    <path class="st1" d="M19.13,32.51h-2.88v-15.3h2.88V32.51z" />
                    <path class="st1"
                        d="M29.4,26.11h-4.7v6.4h-2.88v-15.3H32.1v15.3h-2.7V26.11z M24.69,19.83v3.78h4.7v-3.78H24.69z" />
    ...
    <div class="top-bar visible-md-up">
        <div class="con height-100p flex flex-ai-c">
