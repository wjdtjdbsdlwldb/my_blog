...
<head>
    ...
    <link rel="stylesheet" href="/pf/hd/font/font.css">
        ...
        <div class="con2">
            ...
            <section class="sd-box">
                <div class="main-slide con">
                    <div class="slider1">
                        <div class="bn1 bn"></div>
                        <div class="bn2 bn"></div>
                        <div class="bn3 bn"></div>
                    </div>
                    <div class="circle">
                        <p>공지사항</p>
                    </div>
            ...
            <section class="noti con">
                ...
                <div class="noti-slider">
                    <div class="nt1 nt">
                        [새소식] 제8기 고객자문단 모집 공고</div>
                    <div class="nt2 nt">
                        [새소식] 2021년 열린강좌 설문조사</div>
                    <div class="nt3 nt">
                        [새소식] 국립현대미술관 청주 개방 수장고 일부 변경 운영 안내</div>
                </div>
            </section>

            <section class="online flex">
                <div class="on-wrap con flex">
                    <div class="txt-box">
                        <h2>온라인<br>미술관</h2>
                        <p>국립현대미술관을 온라인으로<br>만나보세요</p>
                    </div>
                    <nav class="on-video flex">
                        <ul class="flex">
                            <li>
                                <a href="#" class="block"
                                ...
                                <a href="#" class="vd-infor block">
                                    <p class="title">오윤, 춘무인추무의, 1985｜국립현대미술관
                                        윤범모 관장｜열린강좌 미술관소장품강좌</p>
                                    <p>성인</p>
                            ...
                            <li>
                                ...
                                <a href="#" class="vd-infor block">
                                    <p class="title">박래현, 노점, 1956｜국립현대미술관 윤범모 관장｜열린강좌 미술관소장품강좌</p>
                                    <p>성인</p>
                            ...
                            <li>
                                ...
                                <a href="#" class="vd-infor block">
                                    <p class="title">채용신, 고종황제어진｜국립현대미술관 윤범모 관장｜열린강좌 미술관소장품강좌</p>
                                    <p>성인</p>
                ...
                <div class="on-more">
                    <P>온라인 미술관<br>더 자세히 알아보기&emsp;></P>
                </div>
            </section>
            ...
            <section class="collection"
                ...
                <div class="cl-wrap con">
                    <div class="coll-tit flex flex-ai-c">
                        ...
                        <h3 class="tit flex-grow-1">소장품</h3>
                        <div class="cl-more">More</div>
                    </div>
                    <nav class="coll-box">
                        <ul class="flex">
            ...
            <section class="exh-box con">
                <div class="exh-wrap flex">
                    <div class="exh-txt">
                        <h2>전시</h2>
                        <p>Exhibition</p>
                        <div class="line1"></div>
                        <p class="ex-infor">Information</p>
                        <p class="ex-more">More</p>
                    </div>
                    <div class="swiper-container flex">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide sd-img1">
                                <div class="sd-txt">
                                    <p>모두를 위한 미술관, 개를 위한 미술관 </p>
                                    <p>2020.09.04 ~ 2020.10.25</p>
                                    <p>작가&emsp;권도연,김경재,김세진 외 23명</p><br>
                                    <p>장소&emsp;서울 7전시실, 전시마당. 미술관마당, MMCA 필름앤비디오</p>
                                    <p>관람료&emsp;별도공지시까지 무료</p>
                                </div>
                            </div>
                            <div class="swiper-slide sd-img2">
                                <div class="sd-txt">
                                    <p>판화,판화,판화</p>
                                    <p>2020.05.14 ~ 2020.08.16</p>
                                    <p>작가&emsp;국내작가 60여명</p><br>
                                    <p>장소&emsp;과천 2전시실</p>
                                    <p>관람료&emsp;2000원</p>
                                </div>
                            </div>
                            <div class="swiper-slide sd-img3">
                                <div class="sd-txt">
                                    <p>유강열과 친구들: 공예의 재구성</p>
                                    <p>2020.10.15 ~ 2021.02.28</p>
                                    <p>작가&emsp;유강열,정규,이중섭 외 25명</p><br>
                                    <p>장소&emsp;과천 2전시실</p>
                                    <p>관람료&emsp;&emsp;무료</p>
                                </div>
                            </div>
                            <div class="swiper-slide sd-img4">
                                <div class="sd-txt">
                                    <p>국립현대미술관 창동레지던시 입주보고서 2020</p>
                                    <p>2020.11.20 ~ 2020.11.29</p>
                                    <p>작가&emsp;국동완,배인숙,빠키</p>
                                    <p>장소&emsp;레지던시 창동레지던시</p>
                                    <p>관람료&emsp;&emsp;무료</p>
                                </div>
                            </div>
                            <div class="swiper-slide sd-img5">
                                <div class="sd-txt">
                                    <p>개방 수장고 개편</p>
                                    <p>기간 없음</p>
                                    <p>장소&emsp;&emsp;청주</p>
                ...
                <div class="if-wrap"
                    ...
                    <div class="mmca-box con">
                        ...
                        <div class="mc-txt">
                            ...
                            <p>미술문화를 나누는 세계 속 열린 미술관,<br>
                                미술로 감동과 상상력이 넘치는 사회를 만들어 나가겠습니다.
                            </p>
            ...
            <section class="relation">
                <div class="rel-wrap con">
                    <div class="with flex flex-ai-c">
                        <p class="rel-line"></p>
                        <h2>With MMCA</h2>
                    </div>
                </div>
                <div class="rel-box con">
                    <div class="mini-mmca"
                        ...
                        <a href="#" class="block">어린이 미술관은행</a>
                    </div>
                </div>
