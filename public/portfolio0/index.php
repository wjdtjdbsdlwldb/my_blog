...
<head>
    ...
    <link rel="stylesheet" href="/portfolio0/index.css">
    <link rel="stylesheet" href="/portfolio0/font/font.css">
    <script src="/portfolio0/index.js"></script>
</head>

<body>
    <div class="line-box-wrap con-min-width">
        <div class="line-box con">
            <div class="fly-item arrow"><img
                    src="https://wjdtjdbsdlwldb.github.io/img1/blog/article/port/Asset.png?dummy123123" alt=""></div>
            <div class="lines">
                <div class="fly-item"></div>
                <div class="fly-item"></div>
                <div class="fly-item"></div>
            </div>
            <div class="txt-box">
    ...
    <div id="fullpage">
        <div class="section section-1 con-min-width">
            <div class="con height-100p">
                <div class="page-1">
                    <div class="copy">
                        <span>Copyright © 2020 by J. Seo Yun All Rights Reserved</span>
                    </div>
                </div>
            </div>
        </div>

        <div class="section section-2 con-min-width">
                        ...
                        <div class="skills">
                            ...
                            <div class="sk">
                                <ul>
                                    ...
                                    <li class="skill sk-html">
                                        <div class="txt">CSS</div>
                                        <div class="progress-bar">
                                        </div>
                                    </li>
                                    <li class="skill sk-html">
                                        <div class="txt">JS</div>
                                        <div class="progress-bar">
                                        </div>
                                    </li>
                                    <li class="skill sk-html">
        ...
        <div class="section section-3 con-min-width">
            <div class="con page-3 height-100p">
                <div class="web-thu-box">
                    <div class="thu">
                        <div class="img-box-1 box"></div>
                    </div>
                    <div class="tn-box">
                        <div class="txt-box-1"></div>
